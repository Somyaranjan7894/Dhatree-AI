...
def download_and_extract():
    ...
    if not check_kaggle_credentials():
        logging.info("Continuing pipeline by assuming a lightweight default dataset exists or can be manually added.")
        return
    ...
    try:
        ...
        logging.info("Please manually download the dataset and extract it to 'ai/datasets/raw/plantvillage'")
