...
from modules.notifications.serializers.notification_serializers import NotificationSerializer
from modules.notifications.services.notification_service import NotificationService

@extend_schema_view(
    list=extend_schema(description="List all notifications for the authenticated user."),
...
class NotificationViewSet(viewsets.GenericViewSet):
    ...
    def get_queryset(self):
        ...
        if not user or not user.is_authenticated:
            return self.notification_service.notification_repository.model_class.active_objects.none()
    ...
    def mark_read(self, request: Request, pk: str = None) -> Response:
        ...
        updated_notification = self.notification_service.mark_as_read(notification_id=pk)
    ...
    def destroy(self, request: Request, pk: str = None) -> Response:
        ...
        return success_response(data={}, message="Notification deleted successfully.", status_code=status.HTTP_200_OK)
