...
class DashboardOverviewAPIView(APIView):
    ...
    @extend_schema(description="Get actionable insights and overview data for the user dashboard.")
    ...
    def get(self, request: Request) -> Response:
        ...
        return success_response(data=data, message="Dashboard overview retrieved successfully.")
