...
class DiseasePrediction(models.Model):
    ...
    farm = models.ForeignKey(Farm, on_delete=models.SET_NULL, null=True, blank=True, related_name='disease_predictions')
    ...
    metadata = models.JSONField(default=dict, blank=True, help_text="Stores top predictions, grad-cam heatmap, and model version")
    
    # Meta
    is_correct = models.BooleanField(null=True, blank=True, help_text="User feedback if prediction was correct")
