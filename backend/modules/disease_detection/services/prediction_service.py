...
class DiseasePredictionService:
    ...
    def _run_inference(self, image_path):
        ...
        try:
            ...
            model_path = project_root / "ai" / "models" / "disease_detection" / "disease_production_best.keras"
            class_names_path = project_root / "ai" / "models" / "disease_detection" / "class_names.json"
