...
class Crop(models.Model):
    ...
    optimal_temp_max = models.DecimalField(
        _("optimal max temperature (°C)"),
        max_digits=5,
        decimal_places=2,
        blank=True,
        null=True,
    )
    optimal_rainfall_min = models.DecimalField(
        _("optimal min rainfall (mm)"),
        max_digits=6,
        decimal_places=2,
        blank=True,
        null=True,
    )
    optimal_rainfall_max = models.DecimalField(
        _("optimal max rainfall (mm)"),
        max_digits=6,
        decimal_places=2,
        blank=True,
        null=True,
    )
    optimal_humidity_min = models.DecimalField(
        _("optimal min humidity (%)"),
        max_digits=5,
        decimal_places=2,
        blank=True,
        null=True,
    )
    optimal_humidity_max = models.DecimalField(
        _("optimal max humidity (%)"),
        max_digits=5,
        decimal_places=2,
        blank=True,
        null=True,
    ...
    optimal_ph_min = models.DecimalField(
        _("optimal min pH"), max_digits=4, decimal_places=2, blank=True, null=True
    )
    optimal_ph_max = models.DecimalField(
        _("optimal max pH"), max_digits=4, decimal_places=2, blank=True, null=True
    )
    ...
    growth_stages = models.JSONField(
        ...
        default=list,
        blank=True,
        help_text=_("JSON list of growth stages"),
    )
