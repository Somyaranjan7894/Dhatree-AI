...
class SoilSampleViewSet(viewsets.GenericViewSet):
    ...
    def get_queryset(self):
        ...
        return self.soil_service.soil_repository.model_class.active_objects.filter(
            farm__owner=user
        )
    ...
    def retrieve(self, request: Request, pk: str = None) -> Response:
        ...
        return success_response(
            data=serializer.data, message="Soil sample retrieved successfully."
        )
    ...
    def update(self, request: Request, pk: str = None) -> Response:
        ...
        updated_sample = self.soil_service.update_sample(
            sample_id=pk, **serializer.validated_data
        )
        return success_response(
