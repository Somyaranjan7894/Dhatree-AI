...
from modules.disease_diagnosis.serializers.knowledge_serializers import DiseaseSerializer
...
class DiseaseKnowledgeViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    """
    queryset = Disease.objects.prefetch_related('treatments', 'preventions', 'references').all()
