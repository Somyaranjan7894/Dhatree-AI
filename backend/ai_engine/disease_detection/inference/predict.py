...
class DiseasePredictor:
    ...
    def __init__(self, model_path: str = None, class_names_path: str = None):
        ...
        self.model_path = Path(model_path) if model_path else models_registry_dir / "disease_production_best.keras"
        self.class_names_path = Path(class_names_path) if class_names_path else models_registry_dir / "class_names.json"
